...
def get_items():
    ...
    r = requests.get(url, headers={"Authorization": "Token 367fd78a2c51efa9c047f27121845bd90e7e5f88"})
    return r.json()
...
{'checklist_id': 4,
 'delete': False,
 'item_id': 44,
 'modified': '2019-05-27T06:35:50.677610Z',
 'quantity': '3.0000',
 'unit': 'шт',
...
# Подумать над механикой апдейта..
def update_item_in_checklist():
    url = 'http://127.0.0.1:8000/api/v1/checklists/10/'
...
def update_category():
    url = 'http://127.0.0.1:8000/api/v1/categories/5/'
    r = requests.patch(url, headers={"Authorization": "Token 80029d4e0d7ed1833a605e00c1335db9472ef5ff"}, json={
        'name': 'Какашан',
        'color': 'blue',
    })
